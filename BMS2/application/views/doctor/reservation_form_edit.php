...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> แก้ไขการจองเตียง</a></li>
      </ol>
    </section>
		...
		<form role="form"  method="post" name="form1">
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <input class="form-control" type="text" id="HN_patient" name="HN_patient"
													 value="<?php echo $query->HN_patient;?>" maxlength="6">
										  </div>
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <input class="form-control" type="text" id="id_card_patient" maxlength="13" name="id_card_patient"
													 value="<?php echo $query->id_card_patient;?>">
										  </div>
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <input class="form-control" type="text" id="fname_patient"  name="fname_patient"
													 value="<?php echo $query->fname_patient;?>">
										  </div>
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <input class="form-control" type="text" id="lname_patient"  name="lname_patient"
													 value="<?php echo $query->lname_patient;?>">
										  </div>
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <input class="form-control" type="text" id="tell_patient" maxlength="10" name="tell_patient"
													 value="<?php echo $query->tell_patient;?>">
										  </div>
									  ...
									  <div class="form-group">
										  ...
										  <select class="form-control"  name="ref_medicalRight_id">
											  ...
											  <?php foreach ($selectMedicalRight as $row) {?>
												  <option value="<?php echo $row->id_medicalRight; ?>" <?php if($row->id_medicalRight == $query->ref_medicalRight_id){ echo 'selected';} ?>><?php echo  $row->name_medicalRight;?></option>
											  <?php } ?>
										  </select>
									  ...
									  <div class="form-group">
										  ...
										  <div class="input-group">
											  ...
											  <textarea class="form-control pull-right" id="diagnose" name="diagnose"
														value=""><?php echo $query->diagnose;?></textarea>
										  </div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="input-group date">
											...
											<input type="date" class="form-control pull-right" id="datepicker"  value="<?php echo date("Y-m-d", strtotime($query->date_reservation));?>" disabled>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="input-group date">
											...
											<input type="date" class="form-control pull-right" id="datepicker" name="use_date"
												   value="<?php echo date('Y-m-d', strtotime($query->use_date)) ?>">
										</div>
							...
							<div class="form-group">
								...
								<select  class="form-control"  name="ref_ward_id">
									...
									<?php foreach ($selectWard as $row) {?>
										<option value="<?php echo $row->id_ward; ?>" <?php if($row->id_ward == $query->ref_ward_id){ echo 'selected';}?> ><?php echo  $row->name_ward;?></option>
									<?php } ?>
								</select>
							...
							<div id="myDropdown" class="dropdown-content">
								<select class="form-control" name="ref_unit_id">
									...
									<?php foreach ($selectUnit as $row) {?>
										<option value="<?php echo $row->id_unit; ?>" <?php if($row->id_unit == $query->ref_unit_id){ echo 'selected';}?>><?php echo  $row->name_unit;?></option>
									<?php } ?>
								</select>
							</div>
							...
							<div id="myDropdown" class="dropdown-content" name="ref_operation_id">
								<select class="form-control" name="ref_operation_id">
									...
									<?php foreach ($selectOperation as $row) {?>
										<option value="<?php echo $row->id_operation; ?>" <?php if($row->id_operation == $query->ref_operation_id){ echo 'selected';}?>><?php echo  $row->name_operation;?></option>
									<?php } ?>
								</select>
							</div>
								...
								<div id="myDropdown" class="dropdown-content" >
									<select class="form-control" name="ref_staff_id">
										...
										<?php foreach ($selectStaff as $row) {?>
											<option value="<?php echo $row->id_staff; ?>" <?php if($row->id_staff == $query->ref_staff_id){ echo 'selected';}?>><?php echo  $row->fname_staff;?> <?php echo  $row->fname_staff;?></option>
										<?php } ?>
									</select>
								</div>
			...
			<div class="row">
				...
				<a class="btn btn-app btn-primary" onClick="JavaScript:fncSubmit('back')" >
					<i class="fa fa-refresh"></i> ย้อนกลับ
				</a>
				<a class="btn btn-app btn-info" onClick="JavaScript:fncSubmit('adding')">
				<i class="fa fa-save"></i>บันทึก
				</a>
				<input  class="form-control" type="hidden" name="id_reservation" value="<?php echo $query->id_reservation;?>" >
				<input  class="form-control" type="hidden" name="id_patient" value="<?php echo $query->id_patient;?>" >
...
<script language="javascript">
	function fncSubmit(strPage)
	{
		if(strPage == "adding")
		{
			document.form1.action="<?php echo site_url('doctor/reservation_result/update_data')?>";
		}
		if(strPage == "back")
		{
			document.form1.action="<?php echo site_url('doctor/reservation_result')?>";
		}
